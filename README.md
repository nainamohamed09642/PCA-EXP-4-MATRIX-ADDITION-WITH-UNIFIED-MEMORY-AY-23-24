...
## OUTPUT:
### With Memset():
<img width="1014" height="165" alt="image" src="https://github.com/user-attachments/assets/abe1cf75-4c80-4911-a5ac-e4c2cf9305af" />

### Without Memset():
<img width="1011" height="140" alt="image" src="https://github.com/user-attachments/assets/657995b2-e178-4128-8975-f865c6302ccd" />


## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less/more 0.000001time.
